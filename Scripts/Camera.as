...
class Camera
{
	...
	Camera()
	{
		...
		@camera_model = SMesh::loadObjIntoMesh("Models/Misc/Camera/Camera.obj");
		camera_model.SetMaterialFlag(SMaterial::LIGHTING, false);
		camera_model.SetMaterialFlag(SMaterial::BILINEAR_FILTER, false);
	}
